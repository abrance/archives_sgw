...
// 文件开始更新请求
#define CMD_BK_START_UPDATE_REQ 0x00020013
#define CMD_BK_START_UPDATE_RSP 0x00020014

// 文件删除请求，移动作为备份
#define CMD_BK_DELETE_REQ 0x00020015
#define CMD_BK_DELETE_RSP 0x00020016

// 文件粉碎请求
#define CMD_BK_FILE_CRUSH_REQ 0x00020017
#define CMD_BK_FILE_CRUSH_RRP 0x00020018

// 文件重命名请求
#define CMD_BK_RENAME_REQ 0x00020019
#define CMD_BK_RENAME_RSP 0x0002001A

// 目录删除请求
#define CMD_BK_DIR_DELETE_REQ 0x0002001B
#define CMD_BK_DIR_DELETE_RSP 0x0002001C

// 目录重命名请求
#define CMD_BK_DIR_RENAME_REQ 0x0002001D
#define CMD_BK_DIR_RENAME_RSP 0x0002001E
...
typedef struct _taskinfo task_info_t;

extern void pr_task_info(task_info_t *t);
